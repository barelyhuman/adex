...
**_Adex_** is a vite plugin to simplify server rendered apps your development with preact.
      `
    )
  },
  {
  ...
  return (
    <BaseLayout>
      <header class='h-[300px] flex flex-col justify-center'>
        <h1 class='text-xl font-semibold tracking-wide text-zinc-800'>
          Adex
        </h1>
      ...
      <main class='flex gap-10'>
        ...
        <Content
          ...
          dangerouslySetInnerHTML={{
            __html:
              sidebarItems.find((x) => x.key === activeSidebar.value).content
          }}
        />
      </main>
    </BaseLayout>
